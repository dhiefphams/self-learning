...
// get the cell on the default board
...
// Returns the number of now alive cells, or -1 if no cells
// changed this iteration, i.e., stable game.
int board_step() {
  int total_alive = 0;
  int change = 0;
